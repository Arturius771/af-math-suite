##=======================================##
##Project Name:Math Suite
##Date Started: 17/09/2021
##Date Completed:
##Artúr Foden
##www.arturfoden.ie
##=======================================##
##A math suite with functions that solve mathematical problems
##starting with the basic operations (division, adding
